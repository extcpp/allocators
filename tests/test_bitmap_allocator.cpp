...
BOOST_AUTO_TEST_CASE(test_allocate) {
    ...
    BOOST_CHECK(a._memory.ptr == nullptr);
    BOOST_CHECK_EQUAL(a._memory.size, 0);
    ...
    BOOST_CHECK(block2.ptr != block.ptr);
...
BOOST_AUTO_TEST_CASE(test_chunk_alignment) {
    ...
    BOOST_CHECK(block1.ptr != nullptr);
